...
using namespace std;
const string SURNAME1 = "Bognat";
const string SURNAME2 = "Alexeev";
const string SURNAME3 = "Romanov";
const string SURNAME4 = "Mytnik";
const string SURNAME5 = "Kabariha^-^";
const string SURNAME6 = "Borovinsky";
const string SURNAME7 = "Golod";
const string SURNAME8 = "Makarov";
const string NAME1 = "Anastasia";
const string NAME2 = "Nikita";
const string NAME3 = "Billy";
const string NAME4 = "Victor";
const string NAME5 = "lisa";
const string NAME6 = "Dmitriy";
const string NAME7 = "Ilya";
const string NAME8 = "Igor";
const string PATRONOMIC1 = "Viacheslavovich ";
const string PATRONOMIC2 = "Grigorievich";
const string PATRONOMIC3 = "Andreevna";
const string PATRONOMIC4 = "Pavlovich";
const string PATRONOMIC5 = "Alexandrovich";
